    ...
    return (
        <div >
                    ...
                    <section className="container text-lg-center" style={{ paddingTop: "5%",paddingBottom: "9%"  }}>
                        <div className="row justify-content-lg-center align-items-end">
                            ...
                            <div className="col-lg-8 col-md-9 col-sm-12">
                                ...
                                <img src={require('./asserts/banner.png')} alt="banner" className="img-fluid" width={300} height={100} />
                                <h1 className={"mt-3 maroon w-res-75 mx-auto"}>Affordable medication at the lowest possible price</h1>
                                <p className={" mx-auto pt-2"}>Pomegranate Health, in collaboration with Mark Cuban Cost Plug Drug Company, offers hundreds of common (and often life-saving) medications at the lowest possible prices, conveniently shipped directly to your door</p>
                                <a href={"#"} className=" me-2 me-lg-0 btn btn-maroon mt-2 mt-lg-0">Get Started</a>
                            </div>
                            <div className="col hide-on-mobile">
                                <img src={require('./asserts/medication.png')} alt="medication" className={"img-fluid"} width={250} height={800}/>
                            </div>
                        </div>
                    </section>
            ...
            <div className={"py-5 "} style={{ backgroundColor:'#FFF3EF' }}>
                <section className={"bg-ltn-maroon container col-lg-10 mx-auto "} style={{ borderRadius:10, padding:'4.5%', marginTop:"-10%" }}>
            ...
            <div>
                <div className="container py-5">
                    <div className="row">
                        <div className="col-6">
                            <div className="card p-4 w-res-75 mx-auto border-2 shadow"  style={{ backgroundColor:'#F9F3FF' }}>
                                <h1>$5 Copay</h1>
                        ...
                        <div className="col-6">
                            <div className="card p-4 w-res-75 mx-auto border-2 shadow"  style={{ backgroundColor:'#ECF7FE' }}>
                                <h1>$10 Copay</h1>
